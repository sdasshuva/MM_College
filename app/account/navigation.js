            ...
            items: [Ext.create('Ext.grid.Panel', {
                        ...
                        handler: function(grid, rowIndex, colIndex) {
                            ...
                            Ext.Msg.show({
                                ...
                                fn: function(btn, text) {
                                    if (btn == 'yes') {
                                        socket.emit('DestroyNavigation', rec.id).on('DestroyNavigationReturn', function(message) {
                                            if (message == "success") {
                ...
                listeners: {
                    edit: function(column, rowIndex) {
                        ...
                        socket.emit('UpdateNavigation', rec).on('UpdateNavigationReturn', function(message) {
                            if (message == "success") {
                                if (Ext.getCmp('navigation_grid')) {
                                    Ext.getCmp('navigation_grid').getStore().load();
                                }
        ...
        items: [Ext.create('Ext.form.Panel', {
            ...
            buttons: [{
                ...
                handler: function() {
                    ...
                    if (form.isValid()) {
                        socket.emit('CreateNavigation', values).on('CreateNavigationReturn', function(message) {
                            if (message == "success") {
                                if (Ext.getCmp('navigation_grid')) {
                                    Ext.getCmp('navigation_grid').getStore().load();
                                }
