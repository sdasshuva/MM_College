function incomeReportTab(UN) {
    if (Ext.getCmp('income_report_tab')) {
        tab_panel.setActiveTab(Ext.getCmp("income_report_tab"));
    } else {
        var new_tab = tab_panel.add({
            ...
            closable: true,
            autoScroll: false,
            id: 'income_report_tab',
            items: [Ext.create('Ext.grid.Panel', {
                border: false,
                id: 'income_report_grid',
                autoScroll: true,
                store: {
                    proxy: {
                        type: 'ajax',
            ...
            bbar: [{
                ...
                handler: function() {
                    Ext.getCmp('income_report_grid').getStore().load();
                }
            }]
        });
